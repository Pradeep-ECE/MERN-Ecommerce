...
import scrollTop from "../helper/scroolTop.js";
const CategoryWiseProductDisplay = ({ category, heading }) => {
  ...
  return (
    <div className="container mx-auto px-4 my-6 relative">
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,320px))] justify-between md:gap-6 overflow-x-scroll scrollbar-none transition-all delay-200">
       
        {
          ...
          data.map((product, index) => {
          return (
            <Link to={`/product/${product?.id}`} replace  className="w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[320px]  bg-white rounded-sm shadow" onClick={scrollTop}>
